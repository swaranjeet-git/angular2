...
export class HireVehicleComponent implements OnInit {
  ...
  console.log("===> :"+ this.submitForm.get('fromLoc').value," :",
  this.submitForm.get('toLoc').value,": ",
  this.submitForm.get('fromCity').value,": ",
  this.submitForm.get('toCity').value,": ")
  ...
  convertData(inputstatus: string) {
    ...
    return JSON.stringify({
      ...
      fromAddress:this.submitForm.get('fromLoc').value,
      toAddress:this.submitForm.get('toLoc').value,
      fromCity:this.submitForm.get('fromCity').value,
      toCity:this.submitForm.get('toCity').value,
